...
1.[50. Pow(x, n)](https://leetcode-cn.com/problems/powx-n/)（4次）
...
2.[78. 子集](https://leetcode-cn.com/problems/subsets/)（3次）
...
3.[169. 多数元素](https://leetcode-cn.com/problems/majority-element/)（2次）
...
4.[17. 电话号码的字母组合](https://leetcode-cn.com/problems/letter-combinations-of-a-phone-number/)（2次）
