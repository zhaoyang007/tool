...
3.[141. 环形链表](https://leetcode-cn.com/problems/linked-list-cycle/)（4次）
...
1.[20. 有效的括号](https://leetcode-cn.com/problems/valid-parentheses/)（3次）
...
2.[155. 最小栈](https://leetcode-cn.com/problems/min-stack/)（2次）
...
用的最多的除了数组链表之外，就是 map 和 set 了。他们底层结构基本都是使用哈希表来实现的，有的会用二叉树来实现。
