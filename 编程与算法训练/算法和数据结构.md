...
1.[102. 二叉树的层序遍历](https://leetcode-cn.com/problems/binary-tree-level-order-traversal/)（6次）

```js
/*
* 思路：1.bfs
*      2.dfs：访问的时候记录当前节点是在哪一层，把它加在它相应的层即可。
*/
// 1
...
3.[515. 在每个树行中找最大值](https://leetcode-cn.com/problems/find-largest-value-in-each-tree-row/)（5次）
...
4.[200. 岛屿数量](https://leetcode-cn.com/problems/number-of-islands/)（2次）
