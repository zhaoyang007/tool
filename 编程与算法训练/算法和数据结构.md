...
1.[50. Pow(x, n)](https://leetcode-cn.com/problems/powx-n/)（7次）2021.07.28
...
2.[78. 子集](https://leetcode-cn.com/problems/subsets/)（7次）2021.07.29
...
3.[169. 多数元素](https://leetcode-cn.com/problems/majority-element/)（7次）2021.07.30
...
4.[17. 电话号码的字母组合](https://leetcode-cn.com/problems/letter-combinations-of-a-phone-number/)（7次）2021.07.30
...
1.[102. 二叉树的层序遍历](https://leetcode-cn.com/problems/binary-tree-level-order-traversal/)（5次）

```js
/*
* 思路：1.广度优先搜索
*      2.深度优先搜索：访问的时候记录当前节点是在哪一层，把它加在它相应的层即可。
*/
// 1
...
3.[515. 在每个树行中找最大值](https://leetcode-cn.com/problems/find-largest-value-in-each-tree-row/)（4次）
...
4.[200. 岛屿数量](https://leetcode-cn.com/problems/number-of-islands/)（1次）
