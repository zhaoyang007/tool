...
1.[50. Pow(x, n)](https://leetcode-cn.com/problems/powx-n/)（6次）
...
2.[78. 子集](https://leetcode-cn.com/problems/subsets/)（5次）
...
3.[169. 多数元素](https://leetcode-cn.com/problems/majority-element/)（4次）
...
4.[17. 电话号码的字母组合](https://leetcode-cn.com/problems/letter-combinations-of-a-phone-number/)（4次）
...
function levelOrder(root) {
  ...
  function dfs(root, level) {
    ...
    !res[level] ? res[level] = [root.val]res[level].push(root.val);
