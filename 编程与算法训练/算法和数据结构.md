...
js 声明链表数据结构（7次）2021.06.16（8次）2021.06.24
...
3.[141. 环形链表](https://leetcode-cn.com/problems/linked-list-cycle/)（7次）2021.06.16（8次）2021.06.24
...
1.[20. 有效的括号](https://leetcode-cn.com/problems/valid-parentheses/)（7次）2021.06.17（8次）2021.06.25
...
3.[84. 柱状图中最大的矩形](https://leetcode-cn.com/problems/largest-rectangle-in-histogram/)（7次）2021.06.30
...
4.[239. 滑动窗口最大值](https://leetcode-cn.com/problems/sliding-window-maximum/)（7次）2021.06.25
...
1.[242. 有效的字母异位词](https://leetcode-cn.com/problems/valid-anagram/)（7次）2021.06.30
...
2.[49. 字母异位词分组](https://leetcode-cn.com/problems/group-anagrams/)（7次）2021.06.30
...
3.[18. 四数之和](https://leetcode-cn.com/problems/4sum/)（5次）
...
1.[94. 二叉树的中序遍历](https://leetcode-cn.com/problems/binary-tree-inorder-traversal/)（1次）
...
可以迅速的找到一堆数中的最大者或最小者的数据结构。

将根节点最大的堆叫大顶堆，将根节点最小的堆叫小顶堆。常见的堆有二叉堆、斐波那契堆等。
...
2. 依次从根部向下调整整个堆的结构（一直到堆尾即可），HeapifyDown，每次和它的左右儿子比较，跟大于自己的且更大的儿子交换。调整的最坏的情况就是树的深度，就是 log2^n 的。
