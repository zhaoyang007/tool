...
3.[347. 前 K 个高频元素](https://leetcode-cn.com/problems/top-k-frequent-elements/)（6次）
...
3.[22. 括号生成](https://leetcode-cn.com/problems/generate-parentheses/)（5次）
...
4.[98. 验证二叉搜索树](https://leetcode-cn.com/problems/validate-binary-search-tree/)（3次）
...
5.[104. 二叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/)（3次）
...
1.[50. Pow(x, n)](https://leetcode-cn.com/problems/powx-n/)（1次）
