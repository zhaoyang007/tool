...
3.[122. 买卖股票的最佳时机 II](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-ii/)（2次）
...
1.[69. x 的平方根](https://leetcode-cn.com/problems/sqrtx/)（3次）
...
2.[367. 有效的完全平方数](https://leetcode-cn.com/problems/valid-perfect-square/)（2次）
...
3.[33. 搜索旋转排序数组](https://leetcode-cn.com/problems/search-in-rotated-sorted-array/)（1次）
...
1.斐波那契 1.傻递归 2.记忆化递归 3.for 循环递推
