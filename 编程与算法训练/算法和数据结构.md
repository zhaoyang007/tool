...
1.[剑指 Offer 40. 最小的k个数](https://leetcode-cn.com/problems/zui-xiao-de-kge-shu-lcof/)（4次）
...
3.[347. 前 K 个高频元素](https://leetcode-cn.com/problems/top-k-frequent-elements/)（3次）
...
3.[22. 括号生成](https://leetcode-cn.com/problems/generate-parentheses/)（2次）
