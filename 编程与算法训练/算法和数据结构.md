...
用递推，数学归纳法找重复性。用计算机的思维去理解解决问题，不要人肉递归。
...
1.[283. 移动零](https://leetcode-cn.com/problems/move-zeroes/)（3次）
...
2.[11. 盛最多水的容器](https://leetcode-cn.com/problems/container-with-most-water/)（3次）
...
3.[70. 爬楼梯](https://leetcode-cn.com/problems/climbing-stairs/)（2次）
...
4.[1. 两数之和](https://leetcode-cn.com/problems/two-sum/)
