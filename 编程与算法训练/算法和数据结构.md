...
4.[98. 验证二叉搜索树](https://leetcode-cn.com/problems/validate-binary-search-tree/)（5次）
...
5.[104. 二叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/)（5次）
...
1.[50. Pow(x, n)](https://leetcode-cn.com/problems/powx-n/)（3次）
...
2.[78. 子集](https://leetcode-cn.com/problems/subsets/)（2次）
...
3.[169. 多数元素](https://leetcode-cn.com/problems/majority-element/)（1次）
...
4.[17. 电话号码的字母组合](https://leetcode-cn.com/problems/letter-combinations-of-a-phone-number/)（1次）
