...
用递推，数学归纳法找重复性。用计算机的思维去思考理解和解决问题，不要人肉递归。
...
1.[283. 移动零](https://leetcode-cn.com/problems/move-zeroes/)（4次）
...
2.[11. 盛最多水的容器](https://leetcode-cn.com/problems/container-with-most-water/)（4次）
...
3.[70. 爬楼梯](https://leetcode-cn.com/problems/climbing-stairs/)（3次）
...
4.[1. 两数之和](https://leetcode-cn.com/problems/two-sum/)（1次）
...
5.[15. 三数之和](https://leetcode-cn.com/problems/3sum/)（1次）
