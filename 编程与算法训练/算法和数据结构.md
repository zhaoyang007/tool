...
1.[剑指 Offer 10- I. 斐波那契数列](https://leetcode-cn.com/problems/fei-bo-na-qi-shu-lie-lcof/)（7次）2021.08.17
...
3.[63. 不同路径 II](https://leetcode-cn.com/problems/unique-paths-ii/)（7次）2021.08.19

```js
/*
* 路径计数：1.二维数组动态递归 2.取舍最优子结构
* 递归最后才知道确定的值，动态规划就是从确定的值开始递推累加。dp要清楚累加的方向不要弄反。
* 思路：1.递归（自顶向下）
*      2.记忆化递归（自顶向下）
*      3.动态规划循环递推（自底向上）
*/
...
6.[120. 三角形最小路径和](https://leetcode-cn.com/problems/triangle/)（6次）
...
7.[53. 最大子序和](https://leetcode-cn.com/problems/maximum-subarray/)（4次）
