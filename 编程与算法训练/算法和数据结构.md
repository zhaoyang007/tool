...
3.[84. 柱状图中最大的矩形](https://leetcode-cn.com/problems/largest-rectangle-in-histogram/)（2次）
...
4.[239. 滑动窗口最大值](https://leetcode-cn.com/problems/sliding-window-maximum/)（6次）
...
1.[242. 有效的字母异位词](https://leetcode-cn.com/problems/valid-anagram/)（3次）
...
2.[49. 字母异位词分组](https://leetcode-cn.com/problems/group-anagrams/)（3次）
...
3.[18. 四数之和](https://leetcode-cn.com/problems/4sum/)（2次）
