...
2.[155. 最小栈](https://leetcode-cn.com/problems/min-stack/)（6次）
...
4.[239. 滑动窗口最大值](https://leetcode-cn.com/problems/sliding-window-maximum/)（1次）

```js
/*
* 思路：1.暴力 O(n*k)
*      2.双端单调队列 deque O(n)：所有滑动窗口的题目就想到用队列处理就行了。单调队列，保持队首元素是最大值。
*/
// 1
