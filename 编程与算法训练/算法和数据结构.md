...
1.[剑指 Offer 40. 最小的k个数](https://leetcode-cn.com/problems/zui-xiao-de-kge-shu-lcof/)（6次）
...
3.[347. 前 K 个高频元素](https://leetcode-cn.com/problems/top-k-frequent-elements/)（5次）
...
3.[22. 括号生成](https://leetcode-cn.com/problems/generate-parentheses/)（4次）
...
4.[98. 验证二叉搜索树](https://leetcode-cn.com/problems/validate-binary-search-tree/)（2次）
...
5.[104. 二叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/)（2次）
