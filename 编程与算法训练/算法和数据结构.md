...
3.[122. 买卖股票的最佳时机 II](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-ii/)（4次）
...
2.[367. 有效的完全平方数](https://leetcode-cn.com/problems/valid-perfect-square/)（4次）
...
3.[33. 搜索旋转排序数组](https://leetcode-cn.com/problems/search-in-rotated-sorted-array/)（3次）
...
1. 最优子结构 opt[n] = best_of(opt[n - 1], opt[n - 2], ...)，中途淘汰次优解。
2. 存储中间状态：opt[i]
3. 递归公式（状态转移方程）

##### 动态规划实战题目

1.[剑指 Offer 10- I. 斐波那契数列](https://leetcode-cn.com/problems/fei-bo-na-qi-shu-lie-lcof/)（1次）
