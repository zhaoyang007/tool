...
3.[141. 环形链表](https://leetcode-cn.com/problems/linked-list-cycle/)（3次）
...
1.[20. 有效的括号](https://leetcode-cn.com/problems/valid-parentheses/)（2次）
...
2.[155. 最小栈](https://leetcode-cn.com/problems/min-stack/)（1次）
