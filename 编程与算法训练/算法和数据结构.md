...
3.[84. 柱状图中最大的矩形](https://leetcode-cn.com/problems/largest-rectangle-in-histogram/)（4次）
...
1.[242. 有效的字母异位词](https://leetcode-cn.com/problems/valid-anagram/)（4次）
...
2.[49. 字母异位词分组](https://leetcode-cn.com/problems/group-anagrams/)（4次）
...
3.[18. 四数之和](https://leetcode-cn.com/problems/4sum/)（3次）
...
/*
* 思路：1.递归
*      2.基于栈的迭代遍历：手动维护一个栈，因为递归每次调用一个函数，就相当于让系统帮你创建一个栈，把要调用的函数和它相应的参数依次 *        压入栈中。
*      3.莫里斯遍历：建立一个索引树
*      4.颜色标记法
*/
```
