...
3.[122. 买卖股票的最佳时机 II](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-ii/)（6次）
...
1.[69. x 的平方根](https://leetcode-cn.com/problems/sqrtx/)（6次）
...
2.[367. 有效的完全平方数](https://leetcode-cn.com/problems/valid-perfect-square/)（6次）
...
3.[33. 搜索旋转排序数组](https://leetcode-cn.com/problems/search-in-rotated-sorted-array/)（5次）
...
1.[剑指 Offer 10- I. 斐波那契数列](https://leetcode-cn.com/problems/fei-bo-na-qi-shu-lie-lcof/)（3次）
...
3.[63. 不同路径 II](https://leetcode-cn.com/problems/unique-paths-ii/)（1次）
