...
我们还可以利用[路由元信息](https://v3.router.vuejs.org/zh/guide/advanced/meta.html)更细颗粒度地控制滚动。查看完整例子请[移步这里 (opens new window)](https://github.com/vuejs/vue-router/blob/dev/examples/scroll-behavior/app.js)。
