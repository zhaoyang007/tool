...
// http.ServerResponse
// response.setHeader('Content-Type', 'text/html');
// response.setHeaser('Set-Cookie', ['type=ninja', 'language=javascript']);
// response.getHeader('Content-Type')
// response.getHeaderNames();
// response.getHeaders();
// response.hasHeader('Content-Type');
...
// response.statusCode = 404;
// response.statusMessage = 'Not Found';
// response.writeHead(200, 'not found', { 'Content-Type': 'application/json' });
// response.write('hi');
// response.end();
...
// request.setEncoding('utf8')
// request.on('data', chunk => {})
// request.on('end', () => console.log('没有更多数据了'))；
// const http = require('http');
// const url = require('url');
// const qs = require('querystring');
// const server = http.createServer((req, res) => {
...
// http.ServerResponse
// response.setHeader('Content-Type', 'application/json');
// response.setHeader('Set-Header', ['type=ninja', 'language=javascript']);
// response.getHeader('Content-Type');
// response.getHeaders();
// response.getHeaderNames();
// response.hasHeader('Content-Type');
...
//     let params;
//     if (method === 'GET') {
//         params = url.parse(method.url, true).query;
//         console.log(params);
//     } else if (method === 'POST') {
//         let data = '';
//         req.on('data', chunk => {
...
//         error = new Error(`request failed. status code: ${statusCode}`);
//     } else if (!/^application\/json/.test(contentType)) {
//         error = new Error(`invalid content-type. expected application/json but receiced ${contentType}`);
//     }
//     if (error) {
//         console.error(error.message);
//         res.resume();
